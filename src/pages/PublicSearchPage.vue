                    ...
                    <div v-for="facturacion in searchResult.facturaciones" :key="facturacion.id" class="q-mb-md">
                        <q-card bordered>
                                ...
                                <div class="row justify-between items-center">
                                    <div>
                                        ...
                                        <div class="text-caption">
                                            Tipo: <q-badge
                                                :color="facturacion.tipo_contrato === 'FACTURACION' ? 'primary' : 'grey'">
                            ...
                            <q-card-section v-if="facturacion.tipo_contrato === 'FACTURACION'">
                                <div
                                    v-if="!facturacion.estado_subida || facturacion.estado_subida === 'DENEGADO'">
                                    ...
                                    <div class="row items-center q-col-gutter-md">
                                        <div class="col-12 col-sm-8">
                                            <q-file v-model="facturacion.file" label="Seleccionar Factura (PDF)"
                                                outlined dense accept=".pdf" max-file-size="2097152"
                                                @rejected="onRejected">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <q-btn label="Subir Factura" color="primary" icon="cloud_upload"
                                                class="full-width" @click="uploadFactura(facturacion)"
                                                :loading="uploading[facturacion.id]" :disable="!facturacion.file" />
                                        </div>
                                    </div>
                                </div>

                                <div
                                    v-else-if="facturacion.estado_subida === 'SUBIDA' || facturacion.estado_subida === 'APROBADO'">
