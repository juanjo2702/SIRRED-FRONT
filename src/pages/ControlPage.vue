                ...
                <div class="row q-col-gutter-md">
                    ...
                    <div class="col-12 col-sm-12 col-md-4">
                        <q-input
                            ...
                            outlined
                            dense
                            placeholder="Buscar por nombre de docente o CI..."
                            clearable
                        >
                            <template v-slot:prepend>
                                <q-icon name="search" />
            ...
            <template v-slot:body-cell-actions="props">
                <q-td :props="props">
                    <div class="row q-gutter-xs no-wrap">
                        ...
                        <q-btn
                            v-if="props.row.estado_subida === 'SUBIDA'"
                            flat
                            dense
                            round
                            color="positive"
...
export default {
    ...
    setup() {
        ...
        const downloadFactura = (facturacion) => {
            const url = `http://localhost:8000/storage/${facturacion.factura_path}`
